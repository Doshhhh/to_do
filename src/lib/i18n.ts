...
export const translations = {
  ...
  // Habits
  "sidebar.habits": { ru: "Привычки", en: "Habits" },
  "sidebar.tasks": { ru: "Задачи", en: "Tasks" },
  "habits.title": { ru: "Привычки", en: "Habits" },
  "habits.daily": { ru: "Ежедневно", en: "Daily" },
  "habits.weekly": { ru: "раз в неделю", en: "times per week" },
  "habits.specificDays": { ru: "Дни недели", en: "Specific days" },
  "habits.timesPerMonth": { ru: "Раз в месяц", en: "Times per month" },
  "habits.everyNDays": { ru: "Каждые N дней", en: "Every N days" },
  "habits.selectDays": { ru: "Выберите дни", en: "Select days" },
  "habits.everyDays": { ru: "Каждые", en: "Every" },
  "habits.daysInterval": { ru: "дней", en: "days" },
  "habits.thisMonth": { ru: "в этом месяце", en: "this month" },
  "habits.completedToday": { ru: "Выполнено сегодня", en: "Completed today" },
  "habits.markDone": { ru: "Отметить", en: "Mark done" },
  "habits.streak": { ru: "дн. подряд", en: "day streak" },
  "habits.thisWeek": { ru: "на этой неделе", en: "this week" },
  "habits.noHabits": { ru: "Нет привычек. Создайте первую!", en: "No habits. Create the first one!" },
  "habits.newHabit": { ru: "Новая привычка", en: "New habit" },
  "habits.name": { ru: "Название *", en: "Name *" },
  "habits.namePlaceholder": { ru: "Например: Бег", en: "e.g. Running" },
  "habits.frequency": { ru: "Частота", en: "Frequency" },
  "habits.timesPerWeek": { ru: "Раз в неделю", en: "Times per week" },
  "habits.deleteHabit": { ru: "Удалить привычку?", en: "Delete habit?" },
  "habits.deleteMessage": { ru: "будет удалена навсегда вместе с историей.", en: "will be deleted permanently with all history." },
  "habits.bestStreak": { ru: "Лучший streak", en: "Best streak" },
  "habits.weeklyRate": { ru: "За неделю", en: "Weekly rate" },
  "habits.monthlyRate": { ru: "За месяц", en: "Monthly rate" },
